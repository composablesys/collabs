...
export interface RuntimeEventsRecord {
  /**
   * Emitted as soon as possible after processing a [transaction](../../transactions.md).
...
/**
 * The entry point for a Collabs app.
 *
 * Each Collabs app will typically have one `Runtime`,
 ...
 *
 * See the [Getting Started Guide](../../getting_started_guide.md)
...
export class Runtime extends EventEmitter<RuntimeEventsRecord> {
  ...
  /**
   * **Experimental method.**  Track progress at [https://github.com/composablesys/collabs/issues/172](https://github.com/composablesys/collabs/issues/172).
   *
