  ...
  implements TodoListCRDT, collabs.Resettable
{
  ...
  private readonly items: collabs.DeletingMutCList<DeletingTodoListCRDT, []>;
  ...
  constructor(initToken: collabs.InitToken) {
    ...
    this.items = this.addChild(
      ...
      collabs.Pre(collabs.DeletingMutCList)(
        collabs.ConstructorAsFunction(DeletingTodoListCRDT)
      )
    );
  }
  ...
  getItem(index: number): DeletingTodoListCRDT {
...
export class Deleting extends CollabsReplica implements TodoListReplica {
  ...
  constructor(onsend: (msg: Data) => void, replicaIdRng: seedrandom.prng) {
    ...
    this.rootTodoList = this.app.registerCollab(
      "",
      collabs.Pre(DeletingTodoListCRDT)()
    );
  }
}
