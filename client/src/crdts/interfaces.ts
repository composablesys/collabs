...
// CRDT collections.  Values obey Riak map semantics:
...
export interface CMap<K, C extends Crdt> {}
...
export interface CSet<C extends Crdt> {}
...
export interface CList<C extends Crdt> {}
