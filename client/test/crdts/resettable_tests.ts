...
function testResettableViaHistory() {
    // Test Number's resets, which are added via AddAbilitiesViaHistory
    console.log("testResettableViaHistory()...");

    let aliceCounter = new NumberCrdt(alice, "numberReset");
    aliceCounter.addEventListener("Add", event => console.log(
        "Alice: " + event.timestamp.getSender() + " added " + (event as AddEvent).valueAdded));
    ...
    let bobCounter = new NumberCrdt(bob, "numberReset");
    bobCounter.addEventListener("Add", event => console.log(
        "Bob: " + event.timestamp.getSender() + " added " + (event as AddEvent).valueAdded));
...
// TODO: test AddAbilitiesViaChildren

testCounterResets();
testResettableViaHistory();
