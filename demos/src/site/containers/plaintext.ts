...
// TODO: make textarea rows, cols, font-size configurable?
// Can it be inherited via CSS from the outer DOM?
// What would e.g. a React component do?
// (That's somewhat of a different problem from Containers,
// which target whole apps; a React component-like textarea
// would instead be a reusable textarea-with-Crdt for
// embedding and interacting with, not just opaque use.)
