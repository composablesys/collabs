...
A collaborative whiteboard, as a [Collabs containers](https://github.com/composablesys/collabs/blob/master/collabs/docs/containers.md).
...
`dist/whiteboard.html` is the compiled container. It can used in any container host.
