...
[William Hoza](https://williamhoza.com/), as a [Collabs container](https://github.com/composablesys/collabs/blob/master/collabs/docs/containers.md).
...
`dist/aspace.html` is the compiled container. It can used in any container host.
