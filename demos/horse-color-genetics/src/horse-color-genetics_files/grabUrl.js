...
export function encode2(gene1, gene2) {
  var myNum = 0;

  if (gene1) {
    if (document.images[gene1 + "1"].src == path + gene1 + ".png") myNum += 2;
    if (document.images[gene1 + "2"].src == path + gene1 + ".png") myNum += 1;
  }
  if (gene2) {
    if (document.images[gene2 + "1"].src == path + gene2 + ".png") myNum += 8;
    if (document.images[gene2 + "2"].src == path + gene2 + ".png") myNum += 4;
  }
...
export function decode4a(myDigit, gene) {
  var myNum = digitExtend.indexOf(myDigit);
...
export function decodeCR(myDigit) {
  var myNum = digitExtend.indexOf(myDigit);
...
export function decodeKIT(myDigit) {
  var myNum = digitExtend.indexOf(myDigit);
...
export function updateURL() {
  // TODO: use in a plain text box, instead of updating hash
  // var hashString =
  //   "#" +
  //   encode2("e", "g") +
  //   encode4a("a") +
